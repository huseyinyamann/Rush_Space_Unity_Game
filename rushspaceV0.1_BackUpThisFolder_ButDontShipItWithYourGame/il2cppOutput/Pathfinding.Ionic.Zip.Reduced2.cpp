...
IL_0093:
	...
	{
		int32_t L_37;
		L_37 = VirtualFuncInvoker0< int32_t >::Invoke(24, __this);
		int32_t L_38 = L_37;
		V_2 = L_38;
...
IL_0015:
	{
		...
		NullCheck(L_4);
		int32_t L_5;
		L_5 = VirtualFuncInvoker0< int32_t >::Invoke(24, L_4);
		V_2 = L_5;
		int32_t L_6 = V_2;
		if ((((int32_t)L_6) >= ((int32_t)0)))
		{
...
IL_01c3:
	{
		...
		NullCheck(L_92);
		int32_t L_93;
		L_93 = VirtualFuncInvoker0< int32_t >::Invoke(24, L_92);
		V_19 = L_93;
		int32_t L_94 = V_19;
...
IL_022e:
	{
		...
		NullCheck(L_108);
		int32_t L_109;
		L_109 = VirtualFuncInvoker0< int32_t >::Invoke(24, L_108);
		V_21 = L_109;
		int32_t L_110 = V_21;
...
IL_03fd:
	{
		...
		NullCheck(L_227);
		int32_t L_228;
		L_228 = VirtualFuncInvoker0< int32_t >::Invoke(24, L_227);
		V_26 = L_228;
		int32_t L_229 = V_26;
...
IL_0468:
	{
		...
		NullCheck(L_243);
		int32_t L_244;
		L_244 = VirtualFuncInvoker0< int32_t >::Invoke(24, L_243);
		V_28 = L_244;
		int32_t L_245 = V_28;
...
{
	{
		...
		NullCheck(L_0);
		int64_t L_1;
		L_1 = VirtualFuncInvoker2< int64_t, int64_t, int32_t >::Invoke(20, L_0, ((int64_t)0), 0);
		Stream_tF844051B786E8F7F4244DBD218D74E8617B9A2DE* L_2 = __this->___output_2;
		NullCheck(L_2);
		VirtualActionInvoker1< int64_t >::Invoke(21, L_2, ((int64_t)0));
		return;
	}
}
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void BitWriter_WriteBits_m8F23FAE658646C9833D34D99960261DB178C6D5D (BitWriter_tF38140F129818FFB10DC5DB2A24F076702311A45* __this, int32_t ___0_nbits, uint32_t ___1_value, const RuntimeMethod* method) 
...
IL_0013:
	{
		...
		uint32_t L_3 = V_1;
		NullCheck(L_2);
		VirtualActionInvoker1< uint8_t >::Invoke(27, L_2, (uint8_t)((int32_t)(uint8_t)((int32_t)(((int32_t)((uint32_t)L_3>>((int32_t)24)))&((int32_t)255)))));
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void BitWriter_FinishAndPad_m33EDB6CD8E8D82EC4ABAD1935D1371BE29EC3673 (BitWriter_tF38140F129818FFB10DC5DB2A24F076702311A45* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		uint8_t L_3 = V_0;
		NullCheck(L_2);
		VirtualActionInvoker1< uint8_t >::Invoke(27, L_2, L_3);
		int32_t L_4 = __this->___totalBytesWrittenOut_3;
		__this->___totalBytesWrittenOut_3 = ((int32_t)il2cpp_codegen_add(L_4, 1));
	}
...
IL_0105:
	{
		...
		NullCheck(L_38);
		int64_t L_39;
		L_39 = VirtualFuncInvoker2< int64_t, int64_t, int32_t >::Invoke(20, L_38, ((int64_t)0), 0);
		V_8 = (-1);
		V_9 = ((int64_t)0);
...
IL_0174:
	{
		...
		NullCheck(L_52);
		int32_t L_55;
		L_55 = VirtualFuncInvoker3< int32_t, ByteU5BU5D_tA6237BF417AE52AD70CFB4EF24A7A82613DF9031*, int32_t, int32_t >::Invoke(22, L_52, L_53, 0, ((int32_t)(((RuntimeArray*)L_54)->max_length)));
		int32_t L_56 = L_55;
		V_7 = L_56;
